...
const MekanikScreen = ({ navigation, route, orderslist, addOrder, deleteOrder, ...props }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Pilih Mekanik</Text>
      ...
      <TouchableOpacity
        ...
        <Text style={{ color: "red", fontSize: 15, fontWeight: "bold" }}>Next Step</Text>
      </TouchableOpacity>
    </View>
  );
};
...
export default connect(mapStateToProps, mapDispatchToProps)(MekanikScreen);